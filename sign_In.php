        ...
        <div class="col-md-5 ">
            ...
            <?php
                $link = mysqli_connect("localhost","root","","jobs");
                                    ...
                                    {   
                                        //$link = mysqli_connect("localhost","root","","jobs");
                                        $ssql = "select * from company where email='".$_POST['signupEmail']."' and password='".$_POST['signupPassword']."'";
                ...
                <p class="text-center text-secondary mt-2">Don't have an account? <a href="sign_Up.php" class="text-decoration-none  link-primary">Sign up</a></p>
              </form>
        </div>
    </div>
